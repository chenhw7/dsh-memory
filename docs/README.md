...
| [archive/MEMORY_SYSTEM_EVALUATION_v0.9.3.zh.md](./archive/MEMORY_SYSTEM_EVALUATION_v0.9.3.zh.md) | v0.9.3 successor deep evaluation (follow-up to the v0.7.0 report): eight-dimension design/implementation review (identity, capture, recall, KV-cache, retrieval economics, lifecycle, security, human-review governance), four previously-unrecorded code findings, and a P0/P1/P2 roadmap aligned with the standing Agent Note rulings. |
...
| [archive/INDEX_MODE_EVALUATION.zh.md](./archive/INDEX_MODE_EVALUATION.zh.md) | Measured comparison of the three injection modes (policy-only / index / full); reproducible via `tests/recall-golden.spec.ts`. The verdict's current owner is the [digest-first Agent Note](../.agents/notes/implemented/architecture/2026-09-09-memory-digest-first-fence-and-volatility-ordering.md) (the archived comparison's original verdict is recorded in the 2026-08-26 note). |
