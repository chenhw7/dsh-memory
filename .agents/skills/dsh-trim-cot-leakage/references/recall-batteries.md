...
- Exclusions go last so a later include cannot re-admit them: `--glob '!vendor/**' --glob '!node_modules/**' --glob '!lib/**' --glob '!.agents/notes/archived/**' --glob '!.agents/skills/dsh-trim-cot-leakage/**'` (the skill's own files quote leaked wording as calibration), plus test fixtures and golden corpora in scope. The [owning note](../../../notes/implemented/process/2026-08-31-committed-artifact-citations.md) also self-hits through its quoted evidence; judge it as evidence, not usage.
